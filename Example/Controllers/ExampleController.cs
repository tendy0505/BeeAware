...
namespace BeeAware.Controllers
{
    ...
    public class expController : ControllerBase
    {
        ...
        public expController(IConfiguration configuration) // [ModuleName]Controller
        {
        ...
        [Route("Test")] // the route to fetch as api/[ModuleName]/[Route]. e.g: This one is for api/exp/Test
